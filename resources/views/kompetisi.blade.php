...
ACADEMIC
    ...
    <div id="generic-comp-card" class="bg-blue-900 border-4 border-yellow-400 rounded-xl p-8 max-w-lg shadow-2xl transition-all" data-aos="zoom-in" data-aos-delay="100">
        ...
        <p class="text-gray-300 text-sm">
            Lomba Akademik berfokus pada inovasi dan karya ilmiah (LKTI & Coding War), sedangkan Non-Akademik berfokus pada kompetisi E-Sport (Mobile Legends).
        </p>
    </div>

    {{-- Tab Detail Academic BARU (Mengandung 2 Card) --}}
    <div id="academic-detail-tab" class=" w-full flex justify-center card-initial-hidden">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl mx-auto">
            ...
            {{-- Card 1: LKTI (Karya Tulis Ilmiah) --}}
            <div class="w-full">
                <div
                ...
                >
                    ...
                    <div class="absolute blur duration-500 group-hover:blur-none w-72 h-72 rounded-full group-hover:translate-x-12 group-hover:translate-y-12 bg-sky-700 right-1 -bottom-24"></div>
                    <div class="absolute blur duration-500 group-hover:blur-none w-12 h-12 rounded-full group-hover:translate-x-12 group-hover:translate-y-2 bg-indigo-500 right-12 bottom-12"></div>
                    <div class="absolute blur duration-500 group-hover:blur-none w-36 h-36 rounded-full group-hover:translate-x-12 group-hover:-translate-y-12 bg-indigo-600 right-1 -top-12"></div>
                    ...
                    <div class="z-10 flex flex-col justify-evenly w-full h-full text-left">
                        ...
                        {{-- Button for LKTI Details - Use class and data attribute --}}
                        <button
                            class="show-details-btn hover:bg-neutral-200 bg-yellow-400 rounded text-blue-900 font-extrabold w-full p-3 transition duration-300 shadow-md"
                            data-target="lkti"
                        >
            ...
            {{-- Card 2: Coding War Competition (New) --}}
            <div class="w-full">
                <div
                    class="w-full h-80 duration-500 group overflow-hidden relative rounded bg-blue-900 text-neutral-50 p-6 flex flex-col justify-evenly shadow-2xl mx-auto"
                >
                    {{-- Blur elements (Green/Cyan theme) - Adjusted colors for differentiation --}}
                    <div class="absolute blur duration-500 group-hover:blur-none w-72 h-72 rounded-full group-hover:translate-x-12 group-hover:translate-y-12 bg-green-700 right-1 -bottom-24"></div>
                    <div class="absolute blur duration-500 group-hover:blur-none w-12 h-12 rounded-full group-hover:translate-x-12 group-hover:translate-y-2 bg-cyan-500 right-12 bottom-12"></div>
                    <div class="absolute blur duration-500 group-hover:blur-none w-36 h-36 rounded-full group-hover:translate-x-12 group-hover:-translate-y-12 bg-green-600 right-1 -top-12"></div>
                    <div class="absolute blur duration-500 group-hover:blur-none w-24 h-24 bg-cyan-700 rounded-full group-hover:-translate-x-12"></div>

                    <div class="z-10 flex flex-col justify-evenly w-full h-full text-left">
                        <span class="text-2xl font-black uppercase text-yellow-400">Coding War</span>
                        <p class="text-blue-200 text-base">
                            Kompetisi pemrograman untuk menguji kemampuan logika dan efisiensi kode para peserta.
                        </p>
                        {{-- Button for Coding War Details --}}
                        <button
                            class="show-details-btn hover:bg-neutral-200 bg-yellow-400 rounded text-blue-900 font-extrabold w-full p-3 transition duration-300 shadow-md"
                            data-target="codingwar"
                        >
                            Lihat Ketentuan & Syarat
                        </button>
                    </div>
    ...
    {{-- END: Tambahkan Gambar Logo --}}
                    ...
                    <button
                        id="show-ml-details"
                        class="show-details-btn hover:bg-neutral-200 bg-neutral-50 rounded text-red-800 font-extrabold w-full p-3 transition duration-300 shadow-md"
                        data-target="ml"
                    >
                        Lihat Ketentuan & Syarat
                    </button>
...
<div id="lomba-details-wrapper">
    ...
    <div id="lkti-details-content" class="lomba-details-content">
                            ...
                            <div class="mt-4 flex flex-col space-y-3 md:flex-row md:space-y-0 md:space-x-3">
                                ...
                                <button
                                  ...
                                  data-link="https://forms.gle/Y1DQ5zGcsuQ7BoDi9" {{-- Link pendaftaran LKTI --}}
                                   ...
                                   data-qr-src="{{ asset('qr/lkti.png') }}" {{-- Tentukan gambar QR untuk LKTI di sini --}}
    ...
    {{-- 2. CODING WAR DETAILS (Konten Baru, tersembunyi secara default) --}}
    <div id="codingwar-details-content" class="lomba-details-content hidden">

        <section id="codingwar-jadwal" class="py-16">
            <div class="container w-11/12 max-w-6xl mx-auto px-4">
                <h2 class="font-['Arial Black'] text-white text-center mb-10 text-2xl md:text-3xl" data-aos="fade-up">Jadwal Penting Coding War</h2>

                <div class="timeline-card-wrapper max-w-4xl mx-auto">
                    <div class="relative timeline-left" data-aos="fade-right" data-aos-delay="100">
                        <article class="timeline-card mb-12">
                            <div class="mb-2 flex items-center gap-x-2 text-xs">
                                <time class="timeline-badge yellow" datetime="2025-10-18">1 - 25 November 2025</time>
                                <a class="timeline-badge blue" href="#codingwar-syarat">Pendaftaran</a>
                            </div>
                            <h3 class="group relative">
                                <span class="group-hover:text-blue-800 text-lg font-black uppercase leading-6 text-gray-900 transition-all duration-500 ease-in-out">
                                    Registrasi Peserta
                            ...
                            <p class="text-sm mt-3 leading-6 text-gray-700">
                                Waktu pendaftaran untuk kompetisi Coding War.
                            </p>
                            {{-- START: Tambahan Kode Dua Tombol Baru untuk Coding War --}}
                            <div class="mt-4 flex flex-col space-y-3 md:flex-row md:space-y-0 md:space-x-3">
                                <x-shimmer-button
                                    href="https://forms.gle/ContohLinkCodingWar" {{-- Ganti dengan link pendaftaran Coding War --}}
                                    text="DAFTAR SEKARANG"
                                    target="_blank"
                                    class="w-full"
                                />
                                ...
                                <button
                                  id="open-share-modal-codingwar"
                                  data-link="https://forms.gle/ContohLinkCodingWar" {{-- Link pendaftaran Coding War --}}
                                   data-competition="Coding War"
                                   data-qr-src="{{ asset('qr/qr-ml.jpeg') }}" {{-- Jika ada QR khusus, ganti. Jika tidak, gunakan salah satu yang ada. --}}
                                   class="w-full relative inline-flex items-center justify-center overflow-hidden rounded-md bg-blue-600 backdrop-blur-lg px-6 py-2 text-base font-semibold text-white transition-all duration-300 ease-in-out hover:scale-110 hover:shadow-xl hover:shadow-blue-600/50 border border-white/20"
                                      >
                                       <span class="text-lg">
                                      BAGIKAN KE TEMAN
                            ...
                            {{-- END: Tambahan Kode Dua Tombol Baru untuk Coding War --}}
                        </article>
                    </div>
                    ...
                    <div class="relative timeline-right" data-aos="fade-left" data-aos-delay="200">
                        <article class="timeline-card mb-12">
                             <div class="mb-2 flex items-center gap-x-2 text-xs">
                                <time class="timeline-badge yellow" datetime="2025-12-01">29 - 30 November 2025</time>
                            ...
                            <p class="text-sm mt-3 leading-6 text-gray-700">
                                Babak penyisihan Coding War dilaksanakan secara daring/online.
                            </p>
                        </article>
                    </div>
                </div>
        ...
        <section id="codingwar-hadiah" class="py-16">
            <div class="container w-11/12 max-w-6xl mx-auto px-4">
                <h2 class="font-['Arial Black'] text-white text-center mb-10 text-2xl md:text-3xl" data-aos="fade-up">Hadiah & Detail Coding War</h2>

                <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 justify-items-center">

                    {{-- Detail Turnamen --}}
                    <div data-aos="fade-up" class="w-full">
                        <x-dark-glow-card title="Detail Kompetisi" subtitle="Individual / Tim" class="h-auto max-w-full">
                            <ul class="check-list space-y-1">
                                <li class="text-white">Jenis Lomba: Pemrograman Individu</li>
                                <li class="text-white">Bahasa Pemrograman: Bebas</li>
                                <li class="text-white">Biaya Registrasi: **Rp25.000 / Peserta**</li>
                                <li class="text-white">Peserta: Siswa SMA/SMK Sederajat</li>
                            </ul>
                        </x-dark-glow-card>
                    </div>
                    ...
                    <div class="lg:col-span-2 w-full" data-aos="flip-right" data-aos-delay="200">
                        <div class="card m-auto w-full hover:brightness-90 transition-all cursor-pointer group bg-gradient-to-tl from-gray-900 to-gray-950 hover:from-gray-800 hover:to-gray-950 border-r-2 border-t-2 border-gray-900 m-4 rounded-lg overflow-hidden relative">
                            <div class="px-8 py-10 text-gray-400">
                                ...
                                <div class="mt-8">
                                    <p>Biaya Pendaftaran: Rp25.000 / Peserta</p>
                                    <p>Transfer ke:</p>
                                    <p class="font-bold text-xl my-2 text-yellow-400">Bank BNI: 1234 5678 9000 111</p>
                                    <p>(a.n. Peserta Coding War)</p>
                                    <hr class="my-4 border-gray-700">
                                    <p class="font-semibold mb-2 text-white">Hadiah Pemenang:</p>
                                    <ol class="list-decimal list-inside ml-4 text-white">
                                        <li class="mb-1">Uang Pembinaan + Piagam + Merchandise</li>
                                        <li class="mb-1">Uang Pembinaan + Piagam + Merchandise</li>
                                        <li class="mb-1">Uang Pembinaan + Piagam + Merchandise</li>
                                    </ol>
                                </div>
    ...
    {{-- AKHIR CODING WAR DETAILS --}}

    {{-- 3. MLBB (MOBILE LEGENDS) DETAILS (Konten Baru, tersembunyi secara default) --}}
    <div id="ml-details-content" class="lomba-details-content hidden">
